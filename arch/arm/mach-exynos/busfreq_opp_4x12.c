...
static unsigned int exynos4212_mif_volt[ASV_GROUP][LV_END] = {
	...
	{987500, 987500, 937500,  937500,  887500, 887500, 887500}, /* RESERVED */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV1 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV2 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV3 */
	{1025000, 1025000, 975000,  975000,  875000, 875000, 875000}, /* ASV4 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV5 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV6 */
	{925000, 925000, 875000,  875000,  875000, 875000, 875000}, /* ASV7 */
	{925000, 925000, 875000,  875000,  875000, 875000, 825000}, /* ASV8 */
	{925000, 925000, 875000,  875000,  875000, 875000, 825000}, /* ASV9 */
	{925000, 925000, 875000,  875000,  875000, 825000, 825000}, /* ASV10 */
	{912500, 912500, 862500,  862500,  862500, 825000, 825000}, /* RESERVED */
};

static unsigned int exynos4212_int_volt[ASV_GROUP][LV_END] = {
	/* 266      200       200     160    160      133     100 */
	{1275000, 1000000, 1000000, 925000, 925000, 887500, 862500}, /* RESERVED */
	{1037500, 987500, 987500, 912500, 912500, 875000, 850000}, /* ASV1 */
	{1025000, 975000, 975000, 900000, 900000, 862500, 850000}, /* ASV2 */
	{1025000, 975000, 975000, 887500, 887500, 862500, 862500}, /* ASV3 */
	{1037500, 987500, 987500, 900000, 900000, 875000, 850000}, /* ASV4 */
	{1025000, 975000, 975000, 900000, 900000, 862500, 850000}, /* ASV5 */
	{1025000, 975000, 975000, 887500, 887500, 862500, 850000}, /* ASV6 */
	{1012500, 962500, 962500, 887500, 887500, 850000, 850000}, /* ASV7 */
	{1012500, 962500, 962500, 875000, 875000, 850000, 850000}, /* ASV8 */
	{1012500, 962500, 962500, 875000, 875000, 850000, 850000}, /* ASV9 */
	{1012500, 962500, 962500, 875000, 875000, 837500, 825000}, /* ASV10 */
	{1010000, 950000, 950000, 862500, 862500, 825000, 800000}, /* RESERVED */
};

static unsigned int exynos4412_mif_volt[ASV_GROUP][LV_END] = {
	/* 400      400      267      267      160     133     100 */
	{1075000, 1075000, 975000, 975000, 925000, 925000, 925000}, /* RESERVED */
	{1025000, 1025000, 925000,  925000,  875000, 875000, 875000}, /* RESERVED */
	{1025000, 1025000, 925000,  925000,  875000, 875000, 875000}, /* ASV2 */
	{1025000, 1025000, 925000,  925000,  875000, 875000, 875000}, /* ASV3 */
	{1025000, 1025000, 925000,  925000,  875000, 875000, 875000}, /* ASV4 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV5 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV6 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV7 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV8 */
	{975000, 975000, 925000,  925000,  875000, 875000, 825000}, /* ASV9 */
	{975000, 975000, 875000,  875000,  875000, 875000, 825000}, /* ASV10 */
	{975000, 975000, 875000,  875000,  875000, 875000, 825000}, /* RESERVED */
};
...
static unsigned int exynos4412_int_volt[ASV_GROUP][LV_END] = {
  /* GDR : 266       200      200     160    160      133     100 */
	...
	{1037500, 987500, 987500, 900000, 900000, 875000, 837500}, /* ASV4 */
	{1025000, 975000, 975000, 900000, 900000, 862500, 825000}, /* ASV5 */
	{1025000, 975000, 975000, 887500, 887500, 850000, 825000}, /* ASV6 */
	{1012500,  962500,  962500, 887500, 887500, 837500, 825000}, /* ASV7 */
	{1012500,  962500,  962500, 875000, 875000, 837500, 825000}, /* ASV8 */
	{1012500,  962500,  962500, 875000, 875000, 837500, 825000}, /* ASV9 */
	{1012500,  962500,  962500, 875000, 875000, 837500, 825000}, /* ASV10 */
	{1000000,  950000,  950000, 862500, 862500, 825000, 825000}, /* RESERVED */
};
...
static unsigned int exynos4412_mif_volt_rev2[PRIME_ASV_GROUP][LV_END] = {
	...
	{1075000, 1075000, 975000, 975000,  925000, 925000, 925000}, /* RESERVED */
	{1075000, 1075000, 975000, 975000,  925000, 925000, 925000}, /* ASV1 */
	{1075000, 1075000, 975000, 975000,  925000, 925000, 875000}, /* ASV2 */
	{1075000, 1075000, 975000, 975000,  925000, 875000, 875000}, /* ASV3 */
	{1025000, 1025000,  925000,  925000,  875000, 875000, 875000}, /* ASV4 */
	{1025000, 1025000,  925000,  925000,  875000, 875000, 875000}, /* ASV5 */
	{1025000, 1025000,  925000,  925000,  875000, 875000, 875000}, /* ASV6 */
	{1025000, 1025000,  925000,  925000,  875000, 875000, 825000}, /* ASV7 */
	{1025000, 1025000,  925000,  925000,  875000, 825000, 825000}, /* ASV8 */
	{975000, 975000,  875000,  875000,  825000, 825000, 825000}, /* ASV9 */
	{975000, 975000,  875000,  875000,  825000, 825000, 825000}, /* ASV10 */
	{975000, 975000,  875000,  875000,  825000, 825000, 825000}, /* ASV11 */
	{925000,  925000,  825000,  825000,  825000, 825000, 825000}, /* ASV12 */
};

/* 20120822 DVFS table for pega prime */
static unsigned int exynos4412_int_volt_rev2[PRIME_ASV_GROUP][LV_END] = {
  /* GDR : 293       220      220     176      176      147     110 */
	{1062500, 1037500, 1037500, 975000, 975000, 937500, 925000}, /* RESERVED */
	{1050000, 1025000, 1025000,  962500,  962500, 925000, 912500}, /* ASV1 */
	{1037500, 1012500, 1012500,  950000,  950000, 912500, 887500}, /* ASV2 */
	{1025000, 1012500, 1012500,  950000,  950000, 912500, 875000}, /* ASV3 */
	{1012500, 1000000, 1000000,  937500,  937500, 900000, 862500}, /* ASV4 */
	{1000000, 987500, 987500,  925000,  925000, 887500, 862500}, /* ASV5 */
	{987500, 975000, 975000,  912500,  912500, 875000, 862500}, /* ASV6 */
	{975000,  962500,  962500,  900000,  900000, 862500, 850000}, /* ASV7 */
	{1012500,  950000,  950000,  887500,  887500, 850000, 850000}, /* ASV8 */
	{1000000,  937500,  937500,  850000,  850000, 825000, 825000}, /* ASV9 */
	{987500,  912500,  912500,  850000,  850000, 825000, 825000}, /* ASV10 */
	{975000,  900000,  900000,  837500,  837500, 825000, 825000}, /* ASV11 */
	{975000,  887500,  887500,  825000,  825000, 825000, 825000}, /* ASV12 */
};

static unsigned int exynos4412_1ghz_mif_volt[ASV_GROUP][LV_END] = {
	/* 400      400      267      267      160     133     100 */
	{1075000, 1075000, 975000, 975000, 925000, 925000, 925000}, /* RESERVED */
	{1025000, 1025000, 975000, 975000, 925000, 925000, 925000}, /* RESERVED */
	{1025000, 1025000, 975000, 975000, 925000, 925000, 925000}, /* ASV2 */
	{1025000, 1025000, 975000, 975000, 925000, 925000, 925000}, /* ASV3 */
	{1025000, 1025000, 925000,  925000,  875000, 875000, 875000}, /* ASV4 */
	{1025000, 1025000, 925000,  925000,  875000, 875000, 875000}, /* ASV5 */
	{1025000, 1025000, 925000,  925000,  875000, 875000, 875000}, /* ASV6 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV7 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV8 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV9 */
	{975000, 975000, 925000,  925000,  875000, 875000, 875000}, /* ASV10 */
	{1000000, 1000000, 900000,  900000,  900000, 900000, 850000}, /* RESERVED */
};

static unsigned int exynos4412_1ghz_int_volt[ASV_GROUP][LV_END] = {
/* GDR : 266   200     200      160      160     133    100 */
	{0, 1062500, 1062500, 975000, 975000, 950000, 925000}, /* RESERVED */
	{0, 1025000, 1025000, 975000, 975000, 950000, 925000}, /* RESERVED */
	{0, 1025000, 1025000, 975000, 975000, 950000, 925000}, /* ASV2 */
	{0, 1025000, 1025000, 975000, 975000, 950000, 925000}, /* ASV3 */
	{0, 1012500, 1012500,  925000,  925000, 900000, 875000}, /* ASV4 */
	{0, 1012500, 1012500,  925000,  925000, 900000, 875000}, /* ASV5 */
	{0, 1012500, 1012500,  925000,  925000, 900000, 875000}, /* ASV6 */
	{0, 987500, 987500,  912500,  912500, 862500, 850000}, /* ASV7 */
	{0, 987500, 987500,  912500,  912500, 862500, 850000}, /* ASV8 */
	{0, 987500, 987500,  912500,  912500, 862500, 850000}, /* ASV9 */
	{0, 987500, 987500,  912500,  912500, 862500, 850000}, /* ASV10 */
	{0, 975000, 975000,  887500,  887500, 850000, 850000}, /* RESERVED */
};

...
static unsigned int asv_3d_volt_9_table_1ghz_type[MALI_DVFS_STEPS-1][ASV_LEVEL] = {
	{  950000,  925000,  925000,  925000,  900000,  900000,  900000,  875000,  875000,  875000,  875000,  850000},  /* L3(160Mhz) */
#if (MALI_DVFS_STEPS > 1)
	{ 975000,  950000,  950000,  950000,  925000,  925000,  925000,  875000,  875000,  875000,  875000,  850000},  /* L2(266Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{ 1050000, 1025000, 1025000, 1025000, 975000, 975000, 975000,  950000,  950000,  950000,  950000,  900000},  /* L1(350Mhz) */
#if (MALI_DVFS_STEPS > 3)
	{ 1100000, 1075000, 1075000, 1075000, 1050000, 1050000, 1050000, 1000000, 1000000, 1000000, 1000000,  950000},  /* L0(440Mhz) */
#endif
#endif
#endif
};
...
static unsigned int asv_3d_volt_9_table[MALI_DVFS_STEPS-1][ASV_LEVEL] = {
	{  925000,  900000,  875000,  875000,  850000,  850000,  850000,  850000,  825000,  825000,  825000,  825000},  /* L3(160Mhz) */
	{  950000,  925000,  900000,  900000,  900000,  875000,  875000,  850000,  850000,  850000,  850000,  825000},	/* L2(266Mhz) */
	{ 1025000, 1000000, 975000, 975000,  950000,  925000,  925000,  925000,  900000,  900000,  900000,  875000},	/* L1(350Mhz) */
	{ 1075000, 1050000, 1025000, 1025000, 1025000, 1000000, 1000000, 975000, 975000, 975000,  950000,  925000},	/* L0(440Mhz) */
};

static unsigned int asv_3d_volt_9_table_for_prime[MALI_DVFS_STEPS][ASV_LEVEL_PRIME] = {
	{  925000,  912500,  900000,  887500,  870000,  862500,  850000,  837500,  850000,  837500,  825000,  825000,  825000},  /* L4(160Mhz) */
#if (MALI_DVFS_STEPS > 1)
	{  950000,  937500,  925000,  912500,  900000,  887500,  875000,  862500,  870000,  862500,  850000,  850000,  850000},	/* L3(266Mhz) */
#if (MALI_DVFS_STEPS > 2)
	{ 1000000, 987500, 975000,  962500,  950000,  937500,  925000,  912500,  925000,  912500,  887500,  875000,  862500},	/* L2(350Mhz) */
#if (MALI_DVFS_STEPS > 3)
	{ 1062500, 1050000, 1037500, 1000000, 1012500, 1000000, 987500, 975000, 987500, 975000,  950000,  937500,  925000},	/* L1(440Mhz) */
#if (MALI_DVFS_STEPS > 4)
	{ 1125000, 1112500, 1100000, 1087500, 1075000, 1062500, 1050000, 1037500, 1050000, 1037500, 1012500, 1000000, 987500},	/* L0(533Mhz) */
#endif
#endif
#endif
#endif
